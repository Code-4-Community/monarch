...
const loaded: Therapist[] = raw.map((rawTherapist: any) => {
  ...
  return {
    ...
    profilePictureUrl: 'https://ui-avatars.com/api/?background=0D8ABC&color=fff&name=' + rawTherapist['Full Name'].split().join('+'),
    geocode: {
      lat: Number(lat),
      long: Number(long),
      canonicalAddress: ''
...
export interface ApiClient {
  searchTherapists: (query: SearchTherapistsQuery) => Promise<TherapistDisplayModel[]>
...
const RYAN: Therapist = {
  ...
  email: '',
  phone: '',
  profilePictureUrl: 'https://c4cneu-public.s3.us-east-2.amazonaws.com/Board/Ryan_J.jpg',
  geocode: {
    lat: 42.339806,
    long: -71.089172,
...
const SOMYA: Therapist = {
  ...
  email: '',
  phone: '',
  profilePictureUrl: 'https://c4cneu-public.s3.us-east-2.amazonaws.com/Board/2021/somya_prabhakar.jpg',
  geocode: {
    lat: 42.339806,
    long: -70.0989172,
...
const SOFIE: Therapist = {
  ...
  email: '',
  phone: '',
  profilePictureUrl: 'https://c4cneu-public.s3.us-east-2.amazonaws.com/profile-pictures/sofie_duntugan.jfif',
  geocode: {
    lat: 42.439806,
    long: -71.189172,
